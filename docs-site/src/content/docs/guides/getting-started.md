...
Visit the [install page](/guides/install/) and download the binary for your platform, or use the GitHub CLI:
...
Supported platforms are listed on the install page. Only **linux-arm64** is published right now; more will be added as they are built.
...
See [MCP Clients](/guides/mcp-clients/) for copy-paste configuration for Claude Desktop, Cursor, Hermes, and others.
...
- [Install page](/guides/install/) — download links and platform table.
- [MCP clients](/guides/mcp-clients/) — per-client wiring.
- [Tools reference](/reference/tools/) — exact tool schemas and when to use each one.

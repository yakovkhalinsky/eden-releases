---
title: Install Memory MCP Usage skill
description: Use memory as a persistent memory skill inside any stdio MCP client.
content_type: reference
template: doc
skill_name: memory-mcp-usage
skill_version: 3.0.1
skill_tags: mcp, memory, memory-first, stdio, skill
...
skill_related: memory-claude, memory-cursor, memory-hermes
---

# Install Memory MCP Usage skill
...
- [Download `memory-mcp-usage/SKILL.md`](/memory/skills/memory-mcp-usage/SKILL.md)
- Or fetch it from the terminal:

  ```bash
  curl -fsSL https://0d3sa.com/memory/skills/memory-mcp-usage/SKILL.md -o memory-mcp-usage/SKILL.md
  ```

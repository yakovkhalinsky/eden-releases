...
# Install Memory Cursor skill

Use memory as a persistent skill inside Cursor.

## Download this skill

The installable artifact is the raw `SKILL.md` file:

- [Download `memory-cursor/SKILL.md`](/memory/skills/memory-cursor/SKILL.md)
- Or fetch it from the terminal:

  ```bash
  curl -fsSL https://0d3sa.com/memory/skills/memory-cursor/SKILL.md -o memory-cursor/SKILL.md
  ```
...
For step-by-step client wiring, see [Connect Cursor](/memory/tutorials/connect-cursor/).
